...
// }
import 'package:equatable/equatable.dart';
import 'package:seraj_app/screen/public_khatmat/bloc/khatmat_event.dart'; // تأكدي من المسار
import '../../../model/public_khatma_model.dart';
import '../../../model/public_khatma_part.dart';
...
class KhatmaAdded extends KhatmatState {
  final KhatmaModel createdKhatma;
  final List<Map<String, dynamic>> distributionResult;

  const KhatmaAdded({
    required this.createdKhatma,
    required this.distributionResult,
  });

  @override
  List<Object?> get props => [createdKhatma, distributionResult];
}
